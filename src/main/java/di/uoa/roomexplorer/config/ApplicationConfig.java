...
public class ApplicationConfig {
    ...
    public CommandLineRunner initResidence(ResidenceRepo residenceRepo, HostRepo hostRepo) {
        return args -> {
            ...
            residence = new Residence(120.0, "Thessaloniki", "Thessaloniki","Thessaloniki 19", 0.0, 0.0, 1, 2, 2, 1, 1, 35, PRIVATE, 0, 1, hostRepo.findById(2L).get(), LocalDate.of(2023, 2, 10), LocalDate.of(2023, 3, 10), false, false, false, false, false, false, false, false);
            residenceRepo.save(residence);
