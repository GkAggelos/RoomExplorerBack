...
//        return args -> {
//
//            Host host = new Host("giannis", passwordEncoder.encode("2207"), "Giannis", "Triantafyllopoulos", "giannis@gmail.com", "6986534214", "https://a1.muscache.com/ac/users/748818/profile_pic/1384667836/original.jpg?interpolation=lanczos-none&crop=w:w;*,*&crop=h:h;*,*&resize=50:*&output-format=jpg&output-quality=70");
...
//            reservationRepo.save(reservation);
//
//            reservation = new Reservation(LocalDate.now(), LocalDate.of(2023, 2, 22), LocalDate.of(2023, 2, 27), ReservationState.PENDING, residenceRepo.findById(5L).get(), renterRepo.findById(1L).get(), 2, "");
//            reservationRepo.save(reservation);
//
